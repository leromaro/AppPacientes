    ...
    AlertDialog(onDismissRequest = { },
        confirmButton = {
            TextButton(onClick = { navController.popBackStack() }) {
                Text(text = stringResource(id = R.string.entendido))}
            },
        title= {Text(text = stringResource(id = R.string.ayuda))},
        text ={Text(
            "Ingrese los pacientes de manera que el nombre no se repita (PÉREZ I y PÉREZ S)," +
                ...
                "Desde el mismo menú tiene la opción de ${stringResource(id = R.string.borrar)} todo el contenido cargado o ${stringResource(
                    id = R.string.salir
